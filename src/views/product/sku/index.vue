<template>
	<div class="sku-container">
		...
		<el-card class="toolbar-card" shadow="never">
			<el-button v-auth="'product_sku_add'" type="primary" @click="handleAdd">新增SKU</el-button>
		</el-card>
		...
		<el-card class="table-card" shadow="never">
			<el-table v-loading="loading" :data="skuList" border stripe>
				...
				<el-table-column label="操作" width="200" fixed="right">
					<template #default="{ row }">
						<el-button v-auth="'product_sku_edit'" link type="primary" size="small" @click="handleEdit(row)">编辑</el-button>
						<el-button v-auth="'product_sku_del'" link type="danger" size="small" @click="handleDelete(row)">删除</el-button>
					</template>
				</el-table-column>
			</el-table>
