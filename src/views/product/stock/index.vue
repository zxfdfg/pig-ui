		...
		<el-card class="table-card" shadow="never">
			<el-table v-loading="loading" :data="stockList" border stripe>
				...
				<el-table-column label="操作" width="250" fixed="right">
					<template #default="{ row }">
						<el-button link type="primary" size="small" @click="handleIncrease(row)">增加库存</el-button>
						<el-button link type="warning" size="small" @click="handleDecrease(row)">减少库存</el-button>
